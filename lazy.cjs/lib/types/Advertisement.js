...
class Advertisement {
  ...
  get isBuy() {
    return this.type === constants.AdvertisementType.BUY
  }

  get isSell() {
    return this.type === constants.AdvertisementType.SELL
  }

  get isLocalBuy() {
    return this.tradeType === constants.TradeType.LOCAL_BUY
  }

  get isLocalSell() {
    return this.tradeType === constants.TradeType.LOCAL_SELL
  }

  get isOnlineBuy() {
    return this.tradeType === constants.TradeType.ONLINE_BUY
  }

  get isOnlineSell() {
    return this.tradeType === constants.TradeType.ONLINE_SELL
  }
...
Advertisement.fromParams = (params = {}, context) => {
  ...
  data.type = (data.tradeType === constants.TradeType.LOCAL_BUY || data.tradeType === constants.TradeType.ONLINE_BUY) ? constants.AdvertisementType.BUY : constants.AdvertisementType.SELL
  if (data.from) {
  ...
  if (data.referenceType) {
    ...
    if (data.referenceType === 'numbers') {
      data.referenceType = constants.ReferenceType.NUMERIC
    } else if (data.referenceType === 'letters') {
      data.referenceType = constants.ReferenceType.LITERAL
    }
  }
...
Advertisement.from = (data, context) => new Advertisement(data, context)
